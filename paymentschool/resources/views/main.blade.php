...
<head>
  ...
  <title>Kelompok 2 - Payment</title>
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        ...
        <h1 class="sitename">PEMBAYARAN SPP</h1>
      </a>
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            <h1>School Payment BlueSky</h1>
            <p>Our Features Will Make Transactions at School More Easy</p>
            <div class="d-flex">
              <a href="#about" class="btn-get-started">About Us</a>
            </div>
          </div>
          <div class="col-lg-6 order-1 order-lg-2 logo-img" data-aos="zoom-out" data-aos-delay="200">
            <img src="style/assets/img/logo-img.png" class="img-fluid animated" alt="">
          </div>
        </div>
      </div>
    ...
    <section id="team" class="team section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Team</h2>
        <p>REKAYASA PERANGKAT LUNAK KELOMPOK 9 - GROUP PAYMENT </p>
      </div><!-- End Section Title -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member d-flex align-items-start">
              <div class="pic"><img src="style/assets/img/team/team-1.jpeg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Michael Albert Yulianto</h4>
                <span>Project Manager</span>
                <p>Semua akan berlalu pada waktunya, marilah kita bangkit!</p>
                <div class="social">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member d-flex align-items-start">
              ...
              <div class="member-info">
                <h4>Jonathan Sovisa</h4>
                <span>Front-End Helper</span>
                <p>Begitu banyak cobaan di dunia ini, serahkanlah pada Tuhan!</p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member d-flex align-items-start">
              <div class="pic"><img src="style/assets/img/team/team-3.png" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Dinda Marettasya</h4>
                <span>DataBase Spesialist</span>
                <p>Aku Anak Bengkulu Bro!</p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="team-member d-flex align-items-start">
              <div class="pic"><img src="style/assets/img/team/team-4.png" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Putra Addo</h4>
                <span>Back-End Develop</span>
                <p>Kalo Ga Tidur Bukan anak SI Namanya!!</p>
                <div class="social">
