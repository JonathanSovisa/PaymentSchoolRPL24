...
<div class="sidebar">
    <div class="logo-container">
        <img src="style/assets/img/logo-img.png" class="logo-img" alt="Logo">
    </div>
    <div class="subheading">MENU</div>
    <ul class="menu">
        <li><a href="/dashboardadmin">Dashboard Admin</a></li>
        <li><a href="/daftarinstansi">Daftar Instansi</a></li>
        <li><a href="/admininstansi">Admin Instansi</a></li>
        <li><a href="/daftartransaksiadmin">Daftar Transaksi</a></li>
        <li><a href="/logtransaksiadmin">Log Transaksi</a></li>
    </ul>
